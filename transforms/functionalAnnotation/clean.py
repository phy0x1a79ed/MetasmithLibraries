...
so the mapper gates the lane at a low score floor downstream -- do not threshold
here. CLEAN writes relative to CWD and /app is read-only under apptainer, so we
